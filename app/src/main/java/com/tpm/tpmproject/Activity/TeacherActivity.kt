...
class TeacherActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        var teacher_1 = Person("Taw Zin Aung","Android",R.drawable.tza)
        var teacher_2 = Person("Kyaw Kyaw Khaing","Android",R.drawable.kkk)
        var teacher_3 = Person("Phone Lin Aung","Android",R.drawable.pla)
        var teacher_4 = Person("Myo Sat Paing","Android",R.drawable.msp)
